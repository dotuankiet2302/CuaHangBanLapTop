...
namespace App_BanLaptop
{
    public class ExcelExport
    {
        ...
        public bool ExportKhachhang(List<khachhang> dataSource, ref string fileName, bool isPrintPreview)
        {
           // Check if data is null
            ...
            return OutSimpleReport(dataSource, replacer, "DanhSachKhachHang", isPrintPreview, ref fileName);
        }
